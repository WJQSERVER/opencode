...
const icons = {
  ...
  shield: {
    viewBox: "0 0 20 20",
    body: `<path d="M9.99935 3.08203L16.0827 5.3737V9.92565C16.0827 14.0694 13.3327 16.2487 9.99935 18.047C6.66602 16.2487 3.91602 14.0694 3.91602 9.92565V5.3737L9.99935 3.08203Z" stroke="currentColor" stroke-linecap="square" stroke-linejoin="round"/>`,
  },
  terminal: {
    viewBox: "0 0 20 20",
